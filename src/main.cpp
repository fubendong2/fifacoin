...
// Copyright (c) 2013 The fifacoin developers
...
uint256 hashGenesisBlock("0x1999fe4151165d561687d0ee36cf57729d403aae4513dd33a148554d7c3e9424");
static const unsigned int timeGenesisBlock = 1396163282;
...
static const int64 nTargetTimespan = 60*60*6; //12 * 60 * 60; // 12 hours
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x1999fe4151165d561687d0ee36cf57729d403aae4513dd33a148554d7c3e9424");
    }
...
*/
        ...
        // Genesis block
        const char* pszTimestamp = "fifacoin...";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0xf41143a6f12c96375b4e987815e2e9a03be4d3ceee9f5bf71891a3af0ba571a2"));
