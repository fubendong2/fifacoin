...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click fifacoin: links)
...
{
    // clicking on fifacoin: URLs creates FileOpen events on the Mac:
